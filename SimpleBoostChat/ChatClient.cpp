...
{
	boost::asio::async_connect(socket, endpoint_iter, [this](const boost::system::error_code& code)
	{
...
void ChatClient::handle_connect(const boost::system::error_code& error)
{
	if (!error)
	{
		boost::asio::async_read(socket, read_msg.header_buffer(), [this](const boost::system::error_code& code)
		{
...
void ChatClient::handle_header_read(const boost::system::error_code& error)
{
	...
	{
		boost::asio::async_read(socket, read_msg.body_buffer(), [this](const boost::system::error_code& code)
		{
...
void ChatClient::do_write(chat::ChatMessage& msg)
{
	...
	boost::asio::async_write(socket, msg_queue.front().message_buffer(), [this](const boost::system::error_code& code)
	{
